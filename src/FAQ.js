...
const FAQ = () => {
  ...
  let FAQs = [
    new FAQ("What is the story behind Book of Mormon Voices?", "The Book of Mormon contains a collection of stories and testimonies and stories from many different authors in ancient America over the course of hundreds of years"),
